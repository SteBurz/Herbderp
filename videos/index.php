...
<head>
<title>Videos - HerbDerp - Waste your free time!</title>
                ...
                <p style="color:#969696" >
          		<h1><a target="_blank" href="post.php?pid=<?php echo $post['id']?>"><?php echo $post['title']; ?></a></h1>
 					...
 					<a target="_blank" href="post.php?pid=<?php echo $post['id']?>"> 							
						<iframe class="video" src="<?php echo $post ['body'] ?>" frameborder="0" allowfullscreen title="<?php echo $post ['title'] ?>"></iframe> 	
					</a>
